...
public class VerificarDadosAlunoActivity extends AppCompatActivity implements View.OnClickListener, ResponseListener<JSONObject> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verificar_dados_aluno);
    ...
    private void tentarEnvio(String matricula, String cpf) {
        AlunoGetterTask task = new AlunoGetterTask(this, this);
    ...
    public void doThis(JSONObject response) {
        if(response == null){
            ...
            try {
                serverMatricula = response.getString("matricula");
